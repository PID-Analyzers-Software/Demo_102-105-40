...
void SSD1306RunMenuRenderer::render(Menu* menu)
{
  ...
  m_display->drawString(64, 0, "13:00       ETO           95%");
  //m_display->drawString(64, 0, "13:00       H2            95%");
  // m_display->drawString(64, 0, "13:00     benzene       95%");

  m_display->drawLine(0, 14, 256, 14);
  m_display->setFont(ArialMT_Plain_24);
  m_display->drawString(60, 18, "0.2");
//  m_display->drawString(60, 18, "12.2");
  ...
  m_display->drawString(64, 51, "AL.        EC         LOG");
  //m_display->drawString(64, 51, "AL.        TCD        LOG");
  // m_display->drawString(64, 51, "AL.      10.6eV       LOG");
